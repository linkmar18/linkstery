      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-24 max-w-2xl mx-auto w-full">
        ...
        >
          ...
          <p className="text-zinc-400 text-lg leading-relaxed mb-8">
            Excato! el valor de las figuras es: 
            <span className="text-red-600 font-black text-2xl"> 234 </span>.
            Estos son los valores digitales en el terminal para desbloquear el sistema.
          </p>
          <Link
