      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-24 max-w-3xl mx-auto w-full">
        ...
        >
          ...
          <p className="text-zinc-300 text-lg leading-relaxed mb-8 text-left">
            Cambia de cámara y ve a un grupo de hombres armados entrando al elevador 
            principal; el tablero marca el piso 40. Kimberly está en ese mismo piso. 
            Sabe que, si intentan entrar por la puerta principal, quedará acorralada. 
            Recuerda los documentos: hay una salida de emergencia oculta detrás de 
            una estantería, pero el cierre electromagnético solo se libera con un 
            código de seguridad basado en la arquitectura del edificio que el jefe 
            mencionó como un "acertijo de bienvenida".
          </p>

          <p className="text-zinc-300 text-lg leading-relaxed mb-8 text-left">
            <span className="text-red-500">En el manual de seguridad</span>, el código de acceso para el piso 40 dice lo 
            siguiente: "Para bajar un escalón en la seguridad, mira el número de tu 
            ubicación. El código es el resultado de multiplicar la cantidad de esquinas 
            que tiene un cuadrado por el número del piso actual, y a ese resultado restarle 
            la mitad de los años que tiene un siglo".
          </p>
